...
export const BusinessDisplay = (props: BusinessResult) => {
    return (
        <>
            <Card sx={{ maxWidth: 760, mb: 1 }}>
                <CardHeader
                    ...
                    action={
                        <Link href={`${Pathname.Business_Edit}/#${props.id}`} passHref>
                ...
                <CardContent style={cardContentStyle}>
                    <Stack spacing={1}>
                        ...
                        <Typography variant="body2" color="textSecondary">
                            <b>Owner: </b>
                            <Link href={`${Pathname.Profile}/#${props.createdBy}`} passHref>
                                {props.createdByName}
                            </Link>
                        </Typography>
                    </Stack>
